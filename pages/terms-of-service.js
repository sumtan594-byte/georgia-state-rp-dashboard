        ...
        <div className="max-w-2xl w-full animate-fade-in-up">
          ...
          <div className="card-glass rounded-2xl p-8 shadow-2xl">
            ...
            <div className="text-gsrp-teal-light/60 text-sm space-y-4 leading-relaxed">
              ...
              <p>The Staff Training quiz is designed to test knowledge of the GSRP Staff Handbook. A minimum score of 75% is required to pass. Quiz results are stored for administrative review.</p>
