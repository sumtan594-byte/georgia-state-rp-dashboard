...
function getStaffDbConfig() {
  ...
  return {
    ...
    connectionLimit: Number(getEnv('STAFF_DB_CONNECTION_LIMIT', 'SESSIONS_DB_CONNECTION_LIMIT', 'DB_CONNECTION_LIMIT') || 1),
    queueLimit: Number(getEnv('STAFF_DB_QUEUE_LIMIT', 'SESSIONS_DB_QUEUE_LIMIT', 'DB_QUEUE_LIMIT') || 50),
