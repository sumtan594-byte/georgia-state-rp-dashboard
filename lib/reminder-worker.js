    ...
    while (true) {
      ...
      for (let i = 0; i < reminders.length; i++) {
        ...
        try {
          ...
          // Fetch fresh data directly from ERLC API (do not rely on panel cache)
          ...
          const playerCount = (serverData.Players || serverData.players || serverData.CurrentPlayers)?.length || serverData.CurrentPlayers || 0;
