...
async function generateTranscriptHTML({ messages, channelName, guildName }) {
  ...
  // hydrate: true = Stencil web components handle rendering client-side inside the iframe,
  // which is correct — the iframe is an isolated document so there's no React conflict.
