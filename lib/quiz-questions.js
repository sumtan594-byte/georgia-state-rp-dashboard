...
export const QUESTION_BANK = {
  ...
  discipline: [
    ...
    },
    {
      id: 'd5',
      type: 'mc',
      text: 'Which of the following would result in a Staff Warning?',
      options: [
        'Disrespect toward High Ranks',
        'Disrespect to members/staff, incorrect punishments',
        'Full abuse of all commands',
        'Breaking ToS',
      ],
      correct: 1,
    ...
    },
    {
      id: 'd6',
      type: 'mc',
      text: 'Which of the following would result in a Staff Strike?',
      options: [
        'Disrespect to members',
        'Disrespect toward High Ranks, unauthorised :h/:m commands',
        'Mass disrespect',
  ...
  commands: [
    {
      ...
      options: [';rdm', ';rdm', ';random', ';deathmatch'],
      correct: 0,
