...
export const ROUTE_EMBEDS = [
  ...
  },
  {
    ...
    description: `Review SSD training material before attempting the quiz.${rolesText(['1372476380096237609'])}`,
  },
  {
  ...
  },
  {
    paths: ['/departments'],
    title: 'Departments',
    description: 'Explore Georgia State Roleplay departments and information.',
  },
  {
    paths: ['/training/attempts'],
    title: 'Quiz Attempts',
    description: `Review submitted SSD quiz attempts and training outcomes.${rolesText(['1372482495035211908'])}`,
  },
  {
    paths: ['/training/analytics'],
    title: 'Training Analytics',
    description: `Analyze SSD quiz performance and training progress.${rolesText(['1372482495035211908'])}`,
  },
  {
