...
export default function LoginScreen() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      <div className="relative z-10 flex items-center gap-8 lg:gap-16 max-w-5xl w-full justify-center">
        {/* Login Card */}
          ...
          <div className="card-glass rounded-2xl p-8 text-center shadow-2xl animate-scale-in">
            ...
            {router.query.error === 'AccessDenied' ? (
              <>
                ...
                <p className="text-gsrp-teal-light/40 text-sm mb-4">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 bg-gsrp-teal hover:bg-gsrp-teal-dark text-white px-6 py-3 rounded-xl font-bold text-sm transition-all duration-200 cursor-pointer mb-6 w-full justify-center"
                >
                  Join our Discord
                </a>
              </>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752c4] text-white px-6 py-3 rounded-xl font-bold text-sm transition-all duration-200 cursor-pointer w-full justify-center"
            >
        ...
        {/* Logo Watermark — right side, hidden on mobile */}
        <div className="hidden lg:flex flex-col items-center justify-center animate-float">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-gsrp-orange/10 to-gsrp-teal/10 rounded-3xl blur-3xl" />
            <img
              src="https://i.imgur.com/70GfmYd.gif"
              alt="GSRP"
              className="relative w-64 h-64 rounded-3xl border border-white/5 object-cover opacity-20 animate-pulse-slow"
            />
          </div>
        </div>
      </div>
