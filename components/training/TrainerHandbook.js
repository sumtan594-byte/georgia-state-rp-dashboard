...
const POST_TRAINING = [
  ...
  'When dealing with player reports, always aim for fairness. If you don’t have direct proof, you may use the 3+ Witness Rule.',
  'If there is a video or screenshot, that takes priority. If no evidence or witnesses are available, de-escalate the situation and issue a verbal warning.',
